...
/*Table structure for table `hunter_category` */

DROP TABLE IF EXISTS `hunter_category`;

CREATE TABLE `hunter_category`
(
...
/*Data for the table `hunter_category` */

insert into `hunter_category`(`id`, `name`, `pid`, `description`, `status`, `create_by`, `create_time`, `update_by`,
