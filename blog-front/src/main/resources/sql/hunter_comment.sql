...
/*Table structure for table `hunter_comment` */

DROP TABLE IF EXISTS `hunter_comment`;

CREATE TABLE `hunter_comment`
(
    `id`                 bigint(20) NOT NULL AUTO_INCREMENT,
    `type`               char(1)      DEFAULT '0' COMMENT '评论类型（0代表文章评论，1代表友链评论）',
    `article_id`         bigint(20)   DEFAULT NULL COMMENT '文章id',
    `root_id`            bigint(20)   DEFAULT '-1' COMMENT '根评论id，-1表示当前就是根评论',
    `content`            varchar(512) DEFAULT NULL COMMENT '评论内容',
    `to_comment_user_id` bigint(20)   DEFAULT '-1' COMMENT '所回复的目标评论的userid，-1表示不是回复',
    `to_comment_id`      bigint(20)   DEFAULT '-1' COMMENT '回复目标评论id，-1表示不是回复',
...
/*Data for the table `hunter_comment` */

insert into `hunter_comment`(`id`, `type`, `article_id`, `root_id`, `content`, `to_comment_user_id`, `to_comment_id`,
