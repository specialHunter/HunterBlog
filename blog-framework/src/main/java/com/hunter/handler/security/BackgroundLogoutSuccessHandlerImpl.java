 ...
 */
@Component
public class BackgroundLogoutSuccessHandlerImpl implements LogoutSuccessHandler {
    ...
    public void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (authentication == null) {
            ...
            // 删除redis中存储的用户信息
            redisTemplate.delete(RedisConstants.BACKGROUND_LOGIN_USER_ID + loginUser.getUser().getId());
            writer.write(
